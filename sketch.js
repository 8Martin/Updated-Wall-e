...
function preload() {
  ...
  boostImg = loadImage("assets/booster.png");
  //LEVEL2//
...
// Interior Of the ship //
  ...
  box_2.shapeColor = rgb(165, 164, 164);
  box_2.visible = false;

  box_1 = createSprite(750,460,120,90);// assemble_b is the sprite with plant symbol // 
  box_1.shapeColor = rgb(198, 198, 198);
  box_1.visible = false;
